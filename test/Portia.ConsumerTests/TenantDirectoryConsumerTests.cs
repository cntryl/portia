...
public sealed class TenantDirectoryConsumerTests
{
    ...
    public async Task WatchersHaveIndependentProgressAcrossOtherWatchersAndSnapshots(bool interveningSnapshot)
    {
        ...
        try
        {
            ...
            Assert.Equal(interveningSnapshot ? TenantLifecycleChangeKind.Removed : TenantLifecycleChangeKind.Added,
                second.Current.Kind);
        }
        finally
        {
    ...
    internal static EventSourcedTenantDirectory<Activated, Deactivated> CreateDirectory(IEventStore store,
