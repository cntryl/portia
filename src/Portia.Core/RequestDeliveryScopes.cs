...
public static class RequestDeliveryScopes
{
    ...
    sealed class FixedQueueFactory(IRequestBus bus, IRequestActorValidator actorValidator, TimeProvider? timeProvider,
        QueueRunnerOptions options, IQueuedRequestTerminalHandler? terminalHandler) : IQueueDeliveryScopeFactory
    {
