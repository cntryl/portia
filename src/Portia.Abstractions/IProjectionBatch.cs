...
/// <summary>
///     Owns an atomic projection unit of work. Disposal releases resources and discards uncommitted
///     work; it must never commit. Implementations enforce checkpoint concurrency.
/// </summary>
