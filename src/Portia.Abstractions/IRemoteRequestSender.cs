...
public interface IRemoteRequestSender
{
    ...
    /// <param name="actorToken">The caller's raw bearer token, or <see langword="null" /> for an
    /// unauthenticated actor — re-validated on the receiving side, not just forwarded as-is.</param>
