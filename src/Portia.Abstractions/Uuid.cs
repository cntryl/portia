...
public readonly record struct Uuid : ISpanParsable<Uuid>, ISpanFormattable, IComparable<Uuid>
{
    ...
    /// </summary>
    public static Uuid DnsNamespace { get; } =
        Parse("6ba7b810-9dad-11d1-80b4-00c04fd430c8", CultureInfo.InvariantCulture);

    /// <summary>
    ///     Gets the RFC namespace UUID for URLs.
    /// </summary>
    public static Uuid UrlNamespace { get; } =
        Parse("6ba7b811-9dad-11d1-80b4-00c04fd430c8", CultureInfo.InvariantCulture);

    /// <summary>
    ///     Gets the RFC namespace UUID for ISO object identifiers.
    /// </summary>
    public static Uuid OidNamespace { get; } =
        Parse("6ba7b812-9dad-11d1-80b4-00c04fd430c8", CultureInfo.InvariantCulture);

    /// <summary>
    ///     Gets the RFC namespace UUID for X.500 distinguished names.
    /// </summary>
    public static Uuid X500Namespace { get; } =
        Parse("6ba7b814-9dad-11d1-80b4-00c04fd430c8", CultureInfo.InvariantCulture);
