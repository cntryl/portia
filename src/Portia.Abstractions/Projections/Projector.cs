...
///     <para>
///         A projector is a pure function of events into its own <see cref="IProjectionStore" />:
...
///     </para>
///     <para>
///         Driving a projector is Portia's job: the members a runner needs are internal, so
///         <c>ProjectorRunner</c> is the only implementation of that role. Subclass this to write a
///         projector; do not expect to write an alternative runner.
///     </para>
/// </summary>
public abstract class Projector
{
    ...
    ///     <paramref name="componentName" /> is the required <c>name</c> argument of <c>AddProjector</c>,
    ///     and null when the projector runs outside hosting — the component's own <see cref="Name" /> is
