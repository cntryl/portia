...
public static class RequestBusExtensions
{
    ...
    public static ValueTask<Result> SendAsync(this IRequestBus bus, IRequest request, ClaimsPrincipal actor,
    ...
    /// <param name="ct">A token that can cancel the operation.</param>
    /// <returns>The outcome of handling the request.</returns>
    public static ValueTask<Result<TOut>> SendAsync<TOut>(this IRequestBus bus, IRequest<TOut> request,
    ...
    public static IAsyncEnumerable<TOut> StreamAsync<TOut>(this IRequestBus bus, IStreamRequest<TOut> request,
        ClaimsPrincipal actor, CancellationToken ct = default)
    {
        ArgumentNullException.ThrowIfNull(bus);
    ...
    /// <param name="ct">A token that can cancel the operation.</param>
    /// <returns>The outcome of handling the request.</returns>
    public static ValueTask<Result> SendAsync(this IRequestBus bus, IRequest request, IExecutionContext parent,
        CancellationToken ct = default)
    {
        ArgumentNullException.ThrowIfNull(bus);
    ...
    /// <returns>The outcome of handling the request.</returns>
    public static ValueTask<Result<TOut>> SendAsync<TOut>(this IRequestBus bus, IRequest<TOut> request,
        IExecutionContext parent, CancellationToken ct = default)
    {
        ArgumentNullException.ThrowIfNull(bus);
        ArgumentNullException.ThrowIfNull(parent);
        return bus.DispatchAsync(request, bus.CreateContext(parent.Actor, RequestMetadata.FromParent(parent)), ct);
        ...
        IExecutionContext parent, CancellationToken ct = default)
    {
        ArgumentNullException.ThrowIfNull(bus);
        ArgumentNullException.ThrowIfNull(parent);
        return bus.DispatchStreamAsync(request, bus.CreateContext(parent.Actor, RequestMetadata.FromParent(parent)),
            ct);
    }
}
