...
///     <see cref="IHostedService" /> that starts when the host starts
...
public static class PortiaFitzHostingServiceCollectionExtensions
{
        ...
        where TWorkload : class, IPartitionWorkload
    {
        ...
        services.TryAddSingleton<IPartitionLeaseCompetitor>(sp =>
            new FitzPartitionLeaseCompetitor(sp.GetRequiredService<ILeaseClient>()));
