...
public static class PortiaHostingServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddPortiaRequestNotificationRunner(this IServiceCollection services)
    {
        ...
        services.TryAddSingleton(sp => new RequestNotificationRunner(
            sp.GetRequiredService<IRequestNotificationConsumer>(),
            sp.GetRequiredService<IRequestDeliveryScopeFactory>(),
            sp.GetService<ILogger<RequestNotificationRunner>>()));
